...
public:
	...
	virtual void visit(const AstIfStatement& if_stmt)					   = 0;
	virtual void visit(const AstWhileLoop& while_loop)					   = 0;
	virtual void visit(const AstForLoop& for_loop)						   = 0;
	virtual void visit(const AstIdentifierExpr& identifier)				   = 0;
	virtual void visit(const AstGenericIdentifierExpr& generic_identifier) = 0;
